/* Shared test harness: a static server and an engine-agnostic launcher.
   ...
   (This duplicates cutie-bear/tests/harness.js on purpose. Each game in this
   repo is an independent package with its own package.json; a shared module
   would mean a workspace, which is a lot of machinery for sixty lines.) */
