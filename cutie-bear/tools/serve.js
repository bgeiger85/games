#!/usr/bin/env node
/*
 * Tiny static server so you can open the game on a phone or iPad on the same
 * wifi without deploying. Node built-ins only, no dependency.
...
http.createServer((req, res) => {
  ...
  console.log('\nCutie Bear is serving src/index.html\n');
